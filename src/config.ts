...
const {
	...
	MESSAGE_SENDING_RATE = '100',

	SET_STATUS_RATE = '10',

	OPEN_ROOM_RATE = '10',

	READ_MESSAGE_RATE = '10',

	SUBSCRIBE_PRESENCE_RATE = '100',
...
export const config = {
	...
	MESSAGES_PER_SECOND: parseInt(HOW_MANY_USERS) * (parseFloat(MESSAGE_SENDING_RATE) / 86400), // 1 day in seconds

	SET_STATUS_PER_SECOND: parseInt(HOW_MANY_USERS) * (parseFloat(SET_STATUS_RATE) / 86400),

	OPEN_ROOM_PER_SECOND: parseInt(HOW_MANY_USERS) * (parseFloat(OPEN_ROOM_RATE) / 86400),

	READ_MESSAGE_PER_SECOND: parseInt(HOW_MANY_USERS) * (parseFloat(READ_MESSAGE_RATE) / 86400),

	SUBSCRIBE_PRESENCE_PER_SECOND: parseInt(HOW_MANY_USERS) * (parseFloat(SUBSCRIBE_PRESENCE_RATE) / 86400),
